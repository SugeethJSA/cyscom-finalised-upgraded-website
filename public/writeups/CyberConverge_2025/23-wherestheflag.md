...
![Screenshot](/writeups/CyberConverge_2025/images/cyberchef.png)

Once decoded, we download the revealed hidden file.

![Screenshot](/writeups/CyberConverge_2025/images/decode.png)

We inspect the contents using `xxd` to view the raw hex data:

![Screenshot](/writeups/CyberConverge_2025/images/outxxd.png)
