...
const content = [
  {
    ...
    content: <EasedImage src={`${import.meta.env.BASE_URL}img/events/finaltrace.jpg`} alt="Final Trace event" />,
  },
  {
    ...
    content: <EasedImage src={`${import.meta.env.BASE_URL}img/events/finaltrace1.jpg`} alt="Final Trace highlights" />,
  },
  {
    ...
    content: <EasedImage src={`${import.meta.env.BASE_URL}img/events/finaltrace2.jpg`} alt="Final Trace gallery" />,
  },
  {
    ...
    content: <EasedImage src={`${import.meta.env.BASE_URL}img/events/cyber-converge.jpg`} alt="Cyber Converge event" />,
  },
  {
    ...
    content: <EasedImage src={`${import.meta.env.BASE_URL}img/events/cyber-converge1.jpg`} alt="Cyber Converge highlights" />,
  },
  {
    title: "VMedithon",
    description:
    ...
    content: <EasedImage src={`${import.meta.env.BASE_URL}img/events/vmedithon.jpg`} alt="VMedithon event" />,
  },
];
