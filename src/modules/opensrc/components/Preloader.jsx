...
const Preloader = ({ assets = [], onComplete }) => {
  ...
  const generateGibberish = () => {
    const cyberFiles = [
      'main.jsx', 'App.jsx', 'Home.jsx', 'Leaderboard.jsx', 'Locker.jsx',
      'HallOfFame.jsx', 'Legacy.jsx', 'leaderboard-mock.json',
      'TargetCursor.jsx', 'Preloader.jsx', 'Navbar.jsx', 'Footer.jsx', 'Button.jsx',
  ...
  useEffect(() => {
    ...
    if (!assets || assets.length === 0) {
      ...
      const interval = setInterval(() => {
        ...
        const mockFiles = ['leaderboard-mock.json', 'zentry-font.woff2', 'logo.png', 'Navbar.jsx', 'Home.jsx', 'index.css'];
